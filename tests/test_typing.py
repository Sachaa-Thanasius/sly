# ruff: noqa: A001, A002, TRY003, TRY004, EM102, B009, S307, RET504, F401
...
# inspect.get_annotations: Below 3.10, vendor it.
...
def test_library_annotations_are_valid(mod: types.ModuleType):
    ...
    for val in filter(can_have_annotations, mod.__dict__.values()):
