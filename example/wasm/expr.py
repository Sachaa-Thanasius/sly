"""expr.py: Proof-of-concept encoding of functions/expressions into Wasm.

Extended Summary
----------------
This file implements a mini-language for writing Wasm functions as expressions. It only supports integers.
...
class ExprLexer(Lexer):
    # fmt: off
    tokens = {
        NAME, NUMBER, PLUS, TIMES, MINUS, DIVIDE, LPAREN, RPAREN, COMMA,
...
if __name__ == "__main__":
    ...
    with open(sys.argv[1]) as fp:
        parser.parse(lexer.tokenize(fp.read()))
